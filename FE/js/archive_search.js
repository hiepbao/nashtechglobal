$ = jQuery;
function loaderInitializationRes() {
...
const ArchiveSearch = (
  ...
  let query_parts = `&category=${category ?? ""}&industry=${
    industry ?? ""
  }&technology_domain=${technology_domain ?? ""}&resource=${
    resource ?? ""
  }&search=${s}`;
  var html_string =
    '<div class="onload-container"><span class="onload-content"> Fetching Posts... </span></div>';
    ...
    success: function (response, textStatus, jqXHR) {
        ...
        if (resource === "-1") {
          cards.forEach((card, index, array) => {
            ...
            if (fullTitle.length > 100) {
              ...
              if (lastSpaceIndex !== -1) {
                shortenedTitle =
                  shortenedTitle.substring(0, lastSpaceIndex) + "...";
              }
            }
            ...
            if (fullexceprt.length > 150) {
              ...
              if (lastSpaceIndex !== -1) {
                shortexceprt =
                  shortexceprt.substring(0, lastSpaceIndex) + "...";
              }
            }
            ...
            const techTermLinks = card.term_links.length
              ? card.term_links.split(", ")
              : [];
          ...
          cards.forEach((card, index, array) => {
            if (card.isSingle) {
              html_string +=
                '<div class="cr-grid-item lightweight" style="display:none"> <div class="cr-grid-item-inner"><div class="cr-thumbWrap">';
              ...
              html_string += "</div>";
              html_string +=
                "<div class='cr-gridContent'> <div class='cr-postDescOuter'>";

              html_string +=
                "<div class='resourceFooter'> <div class='cr-cat'>";
              ...
              html_string +=
                '<div class="cr-grid-item" style="display:none"> <div class="cr-grid-item-inner"><div class="cr-thumbWrap">';
      ...
      if (resource === "-1") {
        ...
        const newUrl =
          ...
          (allEmpty === true ? "" : "?" + urlParams.toString());
      ...
      document
        .querySelector(".onload-container")
        .classList.remove("onload-container-show");
      truncTitle();
    },
  });
};
...
$(function () {
  $(".search_form").submit(function (event) {
    ...
    document
      .querySelector(".onload-container")
      .classList.add("onload-container-show");
    if ($("#selected_category").val() === "resources") {
      //for resources
