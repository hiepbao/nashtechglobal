...
jQuery(document).ready(function (e) {
      ...
      if (jQuery("body").hasClass("single"))
        for (let e = 0; jQuery("#breadcrumbs span span").length > e; e++) {
          ...
          "our thinking" == t
            ...
            : "resources" == t
            ? (jQuery("#breadcrumbs span span").eq(e).find("a")[0].href =
                "/our-thinking/resources/")
            : "panel discussion" == t
            ? (jQuery("#breadcrumbs span span").eq(e).find("a")[0].href =
                "/our-thinking/panel-discussion/")
            : "events" == t &&
              (jQuery("#breadcrumbs span span").eq(e).find("a")[0].href =
                "/our-thinking/events/");
        }
      ...
      (function () {
        for (
          var e,
            t,
            n,
            a = window.location.pathname.split("/").filter(Boolean),
  ...
  jQuery(".cr-grid-item.lightweight").length > 0 &&
    jQuery(".cr-grid-item.lightweight a").click(function () {
      let e = jQuery(this)
        ...
        t = jQuery(this)[0].href.split("/").pop().toLowerCase();
      if ("brochure" == e)
        dataLayer.push({
    ...
    jQuery("a.elementor-button-link.elementor-button").click(function (e) {
      dataLayer.push({
        event: "Button_click",
        buttonLabel: e.currentTarget.innerText,
      });
    }),
    (function () {
      for (let e = 0; jQuery("a").length > e; e++) {
        if (
          ...
          let t = jQuery("a")
            .eq(e)[0]
            .href.split("/")
            [jQuery("a").eq(e)[0].href.split("/").length - 1].split(".")[0]
            .toLowerCase();
      ...
      function (e) {
        ...
        !(function () {
          ...
          if (
            ...
            let ebookName = ebookURL.split("/").pop();
            dataLayer.push({
              event: "Download_ebook",
  ...
  document.addEventListener("DOMContentLoaded", function () {
    ...
    let optionClicked = !1;
    if (supportWrapper && supportSelect) {
