  ...
  n(i).on("load", function () {
    ...
    (y.prototype = {
      ...
      _generateMarkup: function () {
        ...
        var t = n("<div>", { class: "selected-flag" }).appendTo(
          this.flagsContainer
        );
        (this.selectedFlagInner = n("<div>", { class: "flag" }).appendTo(t)),
          n("<div>", { class: "arrow" }).appendTo(t),
      ...
      _setInitialState: function () {
        ...
        (t && this.selectCountry(t), n) ||
          ((this.options.defaultCountry &&
            (i = this._getCountryData(this.options.defaultCountry, !1))) ||
            (i = this.preferredCountries.length
      ...
      _initListeners: function () {
        ...
        i.length &&
          ...
          this.flagsContainer.on("keydown" + n.ns, function (i) {
            !n.countryList.hasClass("hide") ||
              (i.which != r && i.which != u && i.which != p && i.which != l) ||
              (i.preventDefault(), i.stopPropagation(), n._showDropdown()),
    ...
    (n.fn[e] = function (i) {
      var t,
        s = arguments;
      return i === a || "object" == typeof i
        ? this.each(function () {
            n.data(this, "plugin_" + e) ||
              n.data(this, "plugin_" + e, new y(this, i));
          })
        ...
        ? (this.each(function () {
            ...
            a instanceof y &&
              "function" == typeof a[i] &&
              (t = a[i].apply(a, Array.prototype.slice.call(s, 1))),
