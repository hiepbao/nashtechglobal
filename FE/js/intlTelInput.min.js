    ...
    (e.prototype = {
      ...
      _b: function () {
        this._d(),
          ...
          (this.b.onlyCountries.length || this.b.localizedCountries) &&
            this.p.sort(this._countryNameSort);
      },
      _c: function (a, b, c) {
      ...
      _translateCountriesByLocale: function () {
        for (var a = 0; a < this.p.length; a++) {
          ...
          b in this.b.localizedCountries &&
            (this.p[a].name = this.b.localizedCountries[b]);
        }
      },
